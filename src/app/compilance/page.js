...
import {
  ...
  TableFooter, TablePagination, Box, Chip, Stack, Typography, Button
} from "@mui/material";
...
// ---------------- Compliance Training Management Page ----------------
const ComplianceTrainingPage = () => {
  const [features, setFeatures] = useState([
    {
      feature: "Mandatory annual refresher courses",
      description: "Ensures employees complete mandatory compliance training every year.",
      status: "Active",
    },
    {
      feature: "Automated compliance reporting",
      description: "Generates real-time compliance status and progress reports automatically.",
      status: "Active",
    },
    {
      feature: "Audit trails for certification status",
      description: "Maintains complete audit history of training completion and certifications.",
      status: "Active",
    },
  ]);
  ...
  return (
    <Layout>
      <Box p={2} sx={{ backgroundColor: "#f1f8e9", minHeight: "100vh" }}>
          ...
          <Table>
            ...
            <TableBody>
              ...
              {filteredFeatures.length === 0 && (
                <TableRow>
                  <TableCell colSpan={4} align="center">No Features Found</TableCell>
                </TableRow>
              )}
            </TableBody>
