...
import ViewBranch from "@/components/Branch/View/View";
import CreateBranch from "@/components/Branch/Create/Create";
import EditBranch from "@/components/Branch/Edit/Edit";
import DeleteBranch from "@/components/Branch/Delete/Delete";
          ...
          onSearch={(term) => {
            ...
            if (term.trim() === "") {
              ...
              const filtered = rows.filter((row) =>
                row.branchname.toLowerCase().includes(term.toLowerCase()) ||
                row.location.toLowerCase().includes(term.toLowerCase()) ||
