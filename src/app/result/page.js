...
import ViewResult from "@/components/Result/View/View";
import CreateResult from "@/components/Result/Create/Create";
import EditResult from "@/components/Result/Edit/Edit";
import DeleteResult from "@/components/Result/Delete/Delete";
...
const Result = () => {
 ...
 const router = useRouter()
  ...
  const handleStudentResult=(resultId)=>{
     ...
     router.push(`/student-result/${resultId._id}`)
          ...
          onSearch={(term) => {
            ...
            if (term.trim() === "") {
              ...
              const filtered = rows.filter((row) =>
                ...
                row.resultDate.toLowerCase().includes(term.toLowerCase())
              );
              setFilteredRows(filtered);
            }
          }}
