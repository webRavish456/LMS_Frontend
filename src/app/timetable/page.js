          ...
          onSearch={(term) => {
            ...
            if (term.trim() === "") {
              ...
              const filtered = rows.filter((row) =>
                ...
                row.startTiming.toLowerCase().includes(term.toLowerCase()) ||
                row.lastTiming.toLowerCase().includes(term.toLowerCase()) ||
                row.workDays.toLowerCase().includes(term.toLowerCase()) ||
