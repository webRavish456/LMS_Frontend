...
import DeleteScheduling from "@/components/Scheduling/Delete/Delete";
import EditScheduling from "@/components/Scheduling/Edit/Edit";
import ViewScheduling from "@/components/Scheduling/View/View";
import CreateScheduling from "@/components/Scheduling/Create/Create";
...
const Scheduling = () => {
  ...
  const columns = [
    ...
    { id: 'teacherName', label: 'Teacher Name', align: 'center' },
    { id: 'startTiming', label: 'Start Timing', align: 'center' },
    { id: 'lastTiming', label: 'Last Timing', align: 'center' },
    { id: 'workDays', label: 'Work Days', align: 'center' },
  ...
  const handleDelete = async () => {
    setIsDeleting(true);
    try {
      const response = await fetch(`${Base_url}/timetable/${deleteId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
    ...
    <Layout>
      ...
      <Box sx={{ p: 3 }}>
        ...
        <CommonDialog
          ...
          onClose={handleClose}
          dialogTitle={
            openData ? "Create New Scheduling" : viewShow ? "View Scheduling" : editShow ? "Edit Scheduling" : "Delete Scheduling"
          }
          dialogContent={
            openData ? (
              ...
              <EditScheduling editData={editData} handleUpdate={handleUpdate} handleClose={handleClose} />
            ) : deleteShow ? (
              <DeleteScheduling handleDelete={handleDelete} isDeleting={isDeleting} handleClose={handleClose} />
            ) : null
          }
        />
      </Box>
