...
import ViewExam from "@/components/Exam/View/View";
import CreateExam from "@/components/Exam/Create/Create";
import EditExam from "@/components/Exam/Edit/Edit";
import DeleteExam from "@/components/Exam/Delete/Delete";
          ...
          onSearch={(term) => {
            ...
            if (term.trim() === "") {
              ...
              const filtered = rows.filter((row) =>
                row.examName.toLowerCase().includes(term.toLowerCase()) ||
                row.courseName.toLowerCase().includes(term.toLowerCase()) ||
                row.teacherName.toLowerCase().includes(term.toLowerCase()) ||
                row.examDate.toLowerCase().includes(term.toLowerCase()) ||
                row.duration.toLowerCase().includes(term.toLowerCase()) ||
                row.testType.toLowerCase().includes(term.toLowerCase()) ||
                row.totalMarks.toLowerCase().includes(term.toLowerCase()) ||
