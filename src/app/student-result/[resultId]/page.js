...
import ViewStudentResult from "@/components/Result/StudentResult/View/View";
import CreateStudentResult from "@/components/Result/StudentResult/Create/Create";
import EditStudentResult from "@/components/Result/StudentResult/Edit/Edit";
import DeleteStudentResult from "@/components/Result/StudentResult/Delete/Delete";
...
const StudentResult = () => {
  ...
  return (
    ...
    <Search 
          onSearch={(term) => {
            ...
            if (term.trim() === "") {
              ...
              const filtered = rows.filter((row) =>
                ...
                row.marksObtained.toString().includes(term.toLowerCase()) ||
                row.totalMarks.toString().includes(term.toLowerCase()) ||
                row.passingMarks.toString().includes(term.toLowerCase()) ||
          ...
          buttonText="Add New Students Result" />
