          ...
          onSearch={(term) => {
            ...
            if (term.trim() === "") {
              ...
              const filtered = rows.filter((row) =>
                ...
                row.gender.toLowerCase().includes(term.toLowerCase()) ||
                row.mobileNumber.toLowerCase().includes(term.toLowerCase()) ||
                row.emailId.toLowerCase().includes(term.toLowerCase()) ||
                row.dob.toLowerCase().includes(term.toLowerCase()) ||
                row.address.toLowerCase().includes(term.toLowerCase()) ||
                row.enrollmentDate.toLowerCase().includes(term.toLowerCase()) ||
